...
// #ifdef MP-WEIXIN
let websdk = {};
require("../chatpages/utils/Easemob-chat.js", (res) => {
  console.log("require easemob-chat\n", res);
  websdk = res.default;
  WebIM = window.WebIM = uni.WebIM = websdk;
  ...
  WebIM.parseEmoji = function (msg) {
    ...
    console.log("parseEmoji  msgList", msgList);
    ...
    console.log("parseEmoji objList", objList);
    return objList;
  };
  ...
  WebIM.Emoji = {
    path: "../../chatpages/static/images/faces/",
    map: {
      "[微笑]": "hehe.png",
      "[撇嘴]": "piezui.png",
      "[色]": "se.png",
